...
from observatory_server.rules.abandonment import AbandonmentThresholds
from observatory_server.tools.detect_tool_abandonment import NEEDS, detect_tool_abandonment
...
async def test_forwards_thresholds_to_detect() -> None:
    ...
    with patch("observatory_server.tools.detect_tool_abandonment.detect", mock_detect):
